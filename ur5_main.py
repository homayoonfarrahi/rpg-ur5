...
def main(argv):
  ...
  parser.add_argument('--config_file', type=str, default='./configs/mujoco_rpg.json', help='Configuration file for the chosen model')
  ...
  # print(sweeper.config_dicts['num_combinations'])
  ...
  if len(args.slurm_dir) > 0:  
    ...
    cfg['logs_dir'] = f"./logs/{cfg['exp']}/{cfg['seed']}/"
  make_dir(f"./logs/{cfg['exp']}/{cfg['seed']}/")
